...
def usaid_act_fxn_over(chart_name, year_var, country_name_input,username,api_key):
    ...
    barchart = px.bar(
            title = "USAID " + country_name_input + " Funding by Activity (Greater than $1M) for " + year_var,
...
for i in fh_dict_activity:
    usaid_act_fxn_over(fh_dict_activity[i],year_var,i)